...
export default function CreatePostModal({ onClose, onPostCreated, initialData = null }) {
    ...
    const [scheduledDate, setScheduledDate] = useState(initialData ? new Date(initialData.scheduled_at.endsWith('Z') ? initialData.scheduled_at : initialData.scheduled_at + 'Z') : new Date());
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Convertir la date locale en UTC pour envoi au backend
            // toISOString() convertit automatiquement en UTC (format: 2025-12-02T08:15:00.000Z)
